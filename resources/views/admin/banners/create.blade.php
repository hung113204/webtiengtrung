...
<div class="page-header animate-fade-in delay-1">
    <div>
        <h1 class="fs-4 fw-bold mb-1">Thêm Banner mới</h1>
        <p class="text-muted mb-0 small">Tạo một banner mới để hiển thị trên trang chủ.</p>
    </div>
    <div>
        ...
        <form action="{{ route('admin.banners.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="badge_text" value="{{ old('badge_text') }}">
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="title_prefix" value="{{ old('title_prefix') }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-medium">Tiêu đề (Phần nổi bật) <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" name="title_highlight" value="{{ old('title_highlight') }}" required>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="button_primary_text" value="{{ old('button_primary_text') }}">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-medium">Link Nút số 1 <span class="text-muted small">(Vd: #trial)</span></label>
                    <input type="text" class="form-control" name="button_primary_link" value="{{ old('button_primary_link') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="button_secondary_text" value="{{ old('button_secondary_text') }}">
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label fw-medium">Link Nút số 2 <span class="text-muted small">(Vd: #courses)</span></label>
                    <input type="text" class="form-control" name="button_secondary_link" value="{{ old('button_secondary_link') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" class="form-control" name="grid_char_1" value="{{ old('grid_char_1', '你') }}" maxlength="10">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label fw-medium">Chữ Hán 2 (Ô 3) <span class="text-muted small">(Vd: 好)</span></label>
                    <input type="text" class="form-control" name="grid_char_2" value="{{ old('grid_char_2', '好') }}" maxlength="10">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label fw-medium">Chữ Hán 3 (Ô 5) <span class="text-muted small">(Vd: 学)</span></label>
                    <input type="text" class="form-control" name="grid_char_3" value="{{ old('grid_char_3', '学') }}" maxlength="10">
                </div>
                <div class="col-md-3 mb-3">
                    <label class="form-label fw-medium">Chữ Hán 4 (Ô 6) <span class="text-muted small">(Vd: 中)</span></label>
                    <input type="text" class="form-control" name="grid_char_4" value="{{ old('grid_char_4', '中') }}" maxlength="10">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" name="thu_tu" value="{{ old('thu_tu', 0) }}">
                </div>
            ...
            <div class="mt-4 pt-3 border-top border-light d-flex justify-content-end gap-2">
                ...
                <button type="submit" class="btn btn-primary" style="background: var(--admin-primary); border: none;">Tạo Banner</button>
            </div>
        </form>
    </div>
</div>
